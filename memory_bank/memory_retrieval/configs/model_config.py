...
embedding_model_dict = {
    ...
    "text2vec": "/data/sshfs/dataroot/models/GanymedeNil/text2vec-large-chinese", # 应该只会用到这一个字段，用于FAISS，将问答转化为向量（需修改）
    'multilingual-mpnet':"paraphrase-multilingual-mpnet-base-v2",
    'mpnet':"all-mpnet-base-v2",
    'minilm-l6':'/data/sshfs/dataroot/models/all-MiniLM-L6-v2',
...
llm_model_dict = { # 这个东西用不到 以sys_args.py中的设置为准
